    ...
    "crossroads-room": buildRoomBase({
      ...
      messages: [
        ...
        },
        {
          ...
          role: "human",
          verbal_response: "My round-one response",
          timestamp,
          read: true,
          context_status: "default",
        },
        {
          ...
          role: "persona",
          persona_id: "ei",
          verbal_response: "Ei round-one response",
          timestamp,
          read: true,
          context_status: "default",
        },
        {
          ...
          role: "persona",
          persona_id: "007",
          verbal_response: "Sage round-one response",
          timestamp,
          read: false,
          context_status: "default",
        },
    ...
    "crossroads-room": buildRoomBase({
      ...
      messages: [
        ...
        },
        {
          ...
          role: "persona",
          persona_id: "ei",
          verbal_response: "Secret Ei response — should be hidden",
          timestamp,
          read: false,
          context_status: "default",
        },
        {
          ...
          role: "persona",
          persona_id: "007",
          verbal_response: "Secret Sage response — should be hidden",
          timestamp,
          read: false,
          context_status: "default",
        },
